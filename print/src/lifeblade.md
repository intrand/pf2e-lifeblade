...
You gain these features as a Lifeblade. Abilities gained at higher levels list the levels at which you gain them next to the features' names.
...
At 1st level and every even-numbered level thereafter, you gain a lifeblade class feat.
...
You must equip *ancient fist wraps* in order to make use of *tap self* with your fists.
)
...
If you have the *blend essences* lifeblade feat, both auras are always active and you may toggle either aura, but not both, with a free action.
)
...
note (
# Any rules below this page has not yet been implemented. For reference only.
)
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
...
-
;Lifeblade,Stance
You're one step ahead, helping your allies brace for what the enemy may be planning. You enter the Mind Trance stance. When you successfully Strike a creature while in this stance, you gain the Mind Trance Aura until the start of your next turn, which grants you and allies within 15 feet Mind Trance Resilience.

**Mind Trance Resilience** You gain resistances to physical damage equal to half of your level.
)
...
-
;Lifeblade,Stance
Link with enemy creatures' spirits to bolster your allies'. You enter the Spirit Trance stance. When you successfully Strike a creature while in this stance, you gain the Spirit Trance Aura until the start of your next turn, which grants you and allies within 15 feet Spirit Trance Resolve.

**Spirit Trance Resolve** You gain a +1 status bonus to AC and saving throws.
)
...
## Focus 2
-
;Lifeblade,Essence: Mind,Auditory,Concentrate,Emotion,Linguistic,Mental
**Cast** :a: verbal

**Duration** 2 rounds
-
You recite an ancient poem to calm the minds of those around you. In addition to the normal effects of Spirit Trance Resolve, each affected ally may lower their frightened or stupefied condition by 1 at the start of their turn. If an ally has multiple applicable conditions, they choose which condition to lower.
-
**Heightened (3rd)** Add fascinated, sickened and slowed to the list of conditions.

**Heightened (5th)** Add clumsy, drained and enfeebled to the list of conditions.
)
...
-
You force your enemy to bleed. Inflict 1d6+1 bleed damage on a creature within your reach.
-
**Hightened (+1)** Increase the bleed damage by 1.
)
-->
